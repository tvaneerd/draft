...
namespace std {
  ...
  namespace chrono {
    ...
    // \ref{time.zone.db.remote}, remote time zone database
    ...
    // \ref{time.zone.zonedtime}, class \tcode{zoned_time}
...
\pnum
\effects
Streams \tcode{d} into \tcode{os}
using the format specified by the NTCTS \tcode{fmt}.
...
\pnum
Each \tcode{format} overload specified in this section
...
\pnum
Each \tcode{parse} overload specified in this section
